...
class GameFinishedOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget overlayContent = Container(
      color: Colors.black.withValues(alpha: DebugConfig.enableBackdropBlurs ? 0.85 : 0.95),
  ...
  Widget _buildTitle() {
    ...
    if (DebugConfig.enableShimmers) {
      return titleWidget.animate().shimmer(duration: 2.seconds).fadeIn(delay: 200.ms);
    }
    return titleWidget.animate().fadeIn(delay: 200.ms);
  }
